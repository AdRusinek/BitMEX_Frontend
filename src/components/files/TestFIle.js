        ...
        return (
            <div>
                <div>
                    ...
                    <div id="box-content">
                        <br/>
                        <img id="imagesId" src={require('./guidesImages/leverage1.jpg')}/>
                        <p>Wskaźnik LEVERAGE przy dźwigni cross jako wyznacznik wielkości zleceń</p>
                        <p>CO WARTO WIEDZIEĆ</p>
                        <ol>
                            <li>W przypadku braku pozycji wskaźnik</li>
                        </ol>
                        ...
                        <ol start="4">
                            <li>Na początku warto ustawiać niewielkie zlecenia, z czasem jak ogarniecie mechanizm
                                możecie dawać
                        ...
                        <ol>
                            <li>otworzyliśmy niewielką pozycje za 10$,po otworzeniu pozycji za 10$ wskaźnik leverage
                                pokazuje
                                0.10x.
                            </li>
                            <li>Wynika z tego ze aktualnie mamy 1/10 wymaganej pozycji więc dokładamy dodatkowo 90$ co w
                                sumie
